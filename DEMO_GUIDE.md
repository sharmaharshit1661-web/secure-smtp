# 🛡️ Secure SMTP — Judge Presentation & Demo Guide
...
**Secure SMTP** solves this by providing passive, forensic PCAP-based security posture analysis, extracting cryptographic facts, evaluating declarative security rules, computing explainable AI risk scores with SHAP attribution, storing hierarchical dossiers in MongoDB, and flagging protocol anomalies via Isolation Forests.
